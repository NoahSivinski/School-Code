...
Template code for CSCI [4|6]170 Computational Investment
...
class LinRegLearner(object): 
	...
	When we test your code, verbose will in general be False. 
    :type verbose: bool 
    """ 
    ...
    def author(self): 
        ...
        :rtype: str 
        """ 
        return "ingrid"  # replace ingrid with your UGA MyID username 
