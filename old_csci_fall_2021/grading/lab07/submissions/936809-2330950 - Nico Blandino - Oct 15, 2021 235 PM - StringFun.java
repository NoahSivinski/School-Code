 ...
 * 
 * This program will basically take a string of the users choice(that they input)
 * and then allow them to manipulate that string in a variety of ways, through the commands
 * that they can input.
 *
...
public class StringFun {
   ...
   public static void main(String[] args) {
       ...
       do {
           ...
           //replace the first instance of a character with a new character
           ...
           //replaces last instance of a character with a new character
           ...
           //removes all instances of a character from the string
           ...
           //remove one instance of a character from a string
