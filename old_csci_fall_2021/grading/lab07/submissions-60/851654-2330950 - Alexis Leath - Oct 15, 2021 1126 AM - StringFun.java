 ...
 *
 * Purpose: This programs takes a string input from the end user and provides a series of commands for 
 * the user to choose from. Based on the command chooses by the user, the program may ask for more inputs
 * such as characters or an index number. When all necessary information is provided, the program will
 * execute and alter the string based on the commands from the end user.
 *
