 ...
 *
 * Purpose: Prompts user to enter a temperature in Fahrenheit to be converted
 * takes imput value then converts to desired temperature scale, then displays value
