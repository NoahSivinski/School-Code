 ...
 * Author(Debugger): Jacob Tate
 * Submission Date: Friday, October 1st, 2021.
 *
...
public class TemperatureConverter{
 ...
 public static void main(String[] args) {
	 ...
	 // Verify's that the number corresponding to a temperature conversion formula is within proper limits. 
	 ...
	 // Uses the input for the temperature conversion formula and then makes the appropriate conversion. 
	 else {
		 ...
		 //Below, it prints out the fahrenheit temperature and what it is converted to in the end. 
