...
public class TemperatureConverter{
 ...
 public static void main(String[] args) {
	 ...
	 //The following initializes minimum temperature for Fahrenheit
 ...
 //The following lines print to the console
	 System.out.print (
	 ...
	 //The temp scale corresponds to the next integer input by the user
	 tempScale = keyboard.nextInt();
	 keyboard.close();
	 //the temp scale must be 1, 2, 3, or 4
	 if (tempScale < 1 && tempScale > 4) {  
		 System.out.println("Unknown temperature scale  -" +
		 					"  cannot do calculation. Bye");
	 }
	 /*The following equations convert the temperature to the temp
	  * scale that was input by the user
	  */
