 ...
 * This program will input any temperature in fahrenheit that is above -459.67 and then will ask for which conversiontype the user wants.
 * It will then output the converted temperature.
 *
