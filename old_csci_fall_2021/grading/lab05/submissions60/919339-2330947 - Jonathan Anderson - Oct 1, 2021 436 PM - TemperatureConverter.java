 ...
 *
 * Purpose: To debug this program so that it works as intended.
 *
    ...
    public static void main(String[] args) {
        ...
        if (!(tempScale >= 1 && tempScale <= 4)) {  // Second-if statement: Set a breakpoint here
            ...
            if (tempScale == 1) { // Set a breakpoint here
                ...
                convertedDegrees = convertedDegrees + Math.abs(MIN_FAHRENHEIT);
                tempScaleStr="Rankine";

            } else if (tempScale == 3) {
                convertedDegrees = (fahrenheit - 32) / 2.25 ; // Set a breakpoint here
