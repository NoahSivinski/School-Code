 ...
 *
 * Purpose: The purpose of this lab was to use the Eclipse debugger to monitor the value of variables
 * in a Java program by locating the logical errors.
 * 
 * This program does the following: Prompts the user to enter a temperature in Fahrenheit and a
