 ...
 * Author:  [Kritika Rao] 
 * Submission Date:  [10/01/21]
 *
 * Purpose: This program will ask the user to enter a temperature 
 * in fahrenheit. Then, the program will ask the user what temperature
 * they would like to convert too, and will print the fahrenheit
 * temperature in Kelvin, Rankine, Reaumur, or Celsius.
 *
...
public class TemperatureConverter{
	...
	public static void main(String[] args) {
		...
		//Asking user to enter a temperature in Fahrenheit and saving it as fahrenheit.
		...
		//Asking user what scale they would like to convert to 
		System.out.print (
		...
		//Checking if the user entered a valid scale number
		if (tempScale < 1 && tempScale > 4) {  
			System.out.println("Unknown temperature scale  -" +
					"  cannot do calculation. Bye");
		}
		//Calculating the converted temperature based on the user's input 
		else {
			if (tempScale == 1) { 
