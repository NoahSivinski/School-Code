...
public class TemperatureConverter{
 ...
 public static void main(String[] args) {
	 ...
	 // prints out the temperature scales to let the user know which number to input
	 System.out.print (
	 ...
	 //determines weather or not the input is valid. 
	 ...
	 //determines which temp scale the program should use and converts it to the proper form.
	 else {
		 if (tempScale == 1) { // Set a breakpoint here
			 convertedDegrees = (fahrenheit - MIN_FAHRENHEIT)*5/9; //done
			 tempScaleStr="Kelvin"; 
		 } else if (tempScale == 2) {  
