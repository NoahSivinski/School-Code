...
public class TemperatureConverter{
 ...
 public static void main(String[] args) {
	 ...
	 //System.out.println(tempScale+3);
	 ...
	 if (tempScale < 1 && tempScale > 4) {  // Second-if statement: Set a breakpoint here
		 ...
		 if (tempScale == 1) { // Set a breakpoint here
			 convertedDegrees = (fahrenheit + (MIN_FAHRENHEIT*-1))*(5.0/9);
			 tempScaleStr="Kelvin"; 
		 } else if (tempScale == 2) { 
			 ...
			 convertedDegrees = (fahrenheit - 32.0)*(4.0/9) ; // Set a breakpoint here
			 tempScaleStr="Reaumur";
				 
		 } else {
			 convertedDegrees = (fahrenheit - 32.0)*(5.0/9); // Set a breakpoint here
