 ...
 *
 *This program uses the debug function to solve the issues in the following code and convert Fahrenheit
 *into different temperature scales.
 *
...
public class TemperatureConverter 
{
	...
	public static void main(String[] args) 
	{
		...
		if(tempScale < 1 && tempScale > 4) {
			...
			System.out.println(fahrenheit + " degrees Fahrenheit is " + convertedDegrees +
					" degrees " + tempScaleStr + ".");
		}
