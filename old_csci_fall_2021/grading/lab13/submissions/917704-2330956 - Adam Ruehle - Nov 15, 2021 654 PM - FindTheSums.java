 ...
 * This program consists of three methods that print 2D input arrays,
 * then modifies them so that only values adding up to a sum to find on
 * the horizontal or vertical axes are included in the output arrays when
 * they are printed.
 *
