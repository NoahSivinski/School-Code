 ...
 *
 * Purpose: This program takes in a formatted message and splits the information inside of it into
 * categories: category (need, offer, alert, info, unknown), raw cat, message, latitude, longitude,
 * and in range. This information is printed at the end of the program.  
 *
...
public class ClassifyMessage {
	...
	public static void main(String[] args) {
		...
		//get formatted message and start splitting up the information inside of it
		...
		//see if latitude and longitude in range
