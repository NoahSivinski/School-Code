...
public class StarGraph {
	...
	public static void main(String[] args) {
		...
		// Array for y values; Formula: y = 20 * |sin(x)|
		...
		for (int i = 0; i < values; i++) {
			...
			/*
			 * The % is the beginning of a variable replacement in the format string. Last
			 * character f means the program prints a floating point number. The .3 means to
			 * always display 3 decimal places. xValues[i] and yValues[i] replace the "%.3f"
