 ...
 *
 * Purpose: Using two arrays of type double will be stored into multiple
 * values for x and y where y is defined by y=20.0*|sin x|. X and Y are computed 
 * based on the users input and will also print out a graphical representation of the 
 * function.
 *
