 ...
 *
 * Purpose: Parses the user's input into categories and shows the category, latitude, 
 * longitude, and determine if the coordinates are in range.
 *
...
public class ClassifyMessage {
	...
	public static void main(String[] args) {
		...
		catString = keyboard.next();	/*Parses user's input */
		...
		} else if (catString.equalsIgnoreCase("structure") || catString.equals("road") || catString.equals("photo")
				|| catString.equals("evac")) {
