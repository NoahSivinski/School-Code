 ...
 * It stores an array of double values called data. This will 
 * also find the min, max, mode, and average of the values. This
 * class checks if the Stat.java file correctly passes all
 * the tests.
 * 
 *
