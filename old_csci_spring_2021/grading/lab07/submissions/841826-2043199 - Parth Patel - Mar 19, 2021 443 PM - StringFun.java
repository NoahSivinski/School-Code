 ...
 *
 * Purpose: The purpose of this lab is to create an environment where the user can enter a string
 * and then the user is able to manipulate the string using 5 basic commands.
 *
