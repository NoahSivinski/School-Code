 ...
 *
 * Purpose: This program finds two circles' radius, diameter, center, area, 
 * and perimeter. The program then uses this information to compare the two 
...
public class Circle {
	...
	public boolean equals(Circle anotherCircle) {
		...
		if ((Math.abs(radius - anotherCircle.radius) < THRESHOLD) && (Math.abs(x - anotherCircle.x) < THRESHOLD)
