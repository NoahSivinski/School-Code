...
public static final double THRESHOLD = 0.000000001;
	...
	public static void main(String[] args) {
     ...
     // display whether circles are  equal
        if(circle1.equals(circle2))
        	   System.out.println("Circle1 is equal Circle2");
        	else
        	   System.out.println("Circles are not equal");

        
        // display whether circle1 is smaller than circle2 
        if(circle1.isSmaller(circle2))
     	   System.out.println("Circle1 is smaller Circle2");
     	else
     	   System.out.println("Circle1 is not smaller than Circle2");
        
        
     // display whether circle1 intersects circle2 
        if(circle1.intersects(circle2))
     	   System.out.println("Circle1 intersects Circle2");
     	else
     	   System.out.println("Circle1 does not Circle2");
