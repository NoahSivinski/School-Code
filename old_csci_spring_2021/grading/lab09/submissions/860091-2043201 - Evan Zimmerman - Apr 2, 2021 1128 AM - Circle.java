...
public class Circle {
	...
	public boolean equals(Circle anotherCircle) {
		if((Math.abs(this.getRadius() - anotherCircle.getRadius()) < .00000001) && (Math.abs(this.getX() - anotherCircle.getX()) < .00000001) && (Math.abs(this.getY() - anotherCircle.getY()) < .00000001)){return true;} else {return false;}
	}
