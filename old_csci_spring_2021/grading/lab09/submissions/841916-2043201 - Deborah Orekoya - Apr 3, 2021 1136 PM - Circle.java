 ...
 * Purpose:
 * 
 * The purpose of this program is to practice working with
 * classes, objects, methods, instance, and variables. I was
 * able to add code to the existing skeleton methods so that 
 * the classes were able to function. I was then able to use
 * a testing program to illustrate how the components of what
 * I created interacted.
 *
