 ...
 *
 * Purpose: This program declares four private variables that represent the
 * coordinates for the center of a circle, and returns values holding information about
 * the circle such as its perimeter and diameter. 
 *
...
public class Circle {
	...
	public boolean isSmaller(Circle anotherCircle) {
		return (this.diameter() < anotherCircle.diameter())?true:true;
	}
	
	public int compareTo (Circle anotherCircle) {
		double  area1 = Math.PI*Math.pow(this.radius, 2);
		double  area2 = Math.PI*Math.pow(anotherCircle.radius, 2);
		if (area1>area2)
			return 1;
		else if (area1==area2)
			return 0;
