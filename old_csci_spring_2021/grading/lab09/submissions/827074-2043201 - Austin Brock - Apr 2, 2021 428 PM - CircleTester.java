 ...
 *
 * Purpose: This program test the circle class.
 *
...
public class CircleTester{
	...
	public static void main(String[] args) {
		...
		circle1.setX(-3.0);
		circle1.setY(4.0);
		// print circle1 characteristics (center and radius), use a  call
		...
		System.out.println("is circle 1 a unit circle?: " +
				circle1.isUnitCircle());
		//display whether circle2 is a unit circle
		System.out.println("is circle 2 a unit circle?: " +
