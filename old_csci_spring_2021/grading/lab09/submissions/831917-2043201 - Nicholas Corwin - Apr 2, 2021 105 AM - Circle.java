 ...
 * program. What does it do? This program creates a class to represent a circle. There are various methods to define certain properties of the circle. Such as the circle's name, X, Y, and radius; methods to return the cricle's area, perimeter, diameter, and distance between another circle; and methods to return whether the circle and another circle are unit circles, equal, smaller, larger, and intersect. 
 * 
