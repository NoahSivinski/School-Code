 ...
 *
 * Purpose: This program outputs and tests the methods of the
 * circle.java that is in the same package. It recieves the data
 * from that program and prints out the information that is built
 * in circle.java.
 *
...
public class CircleTester{
	...
	public static void main(String[] args) {
		...
		circle2.setX(3);
		circle2.setY(3);
		if (Math.abs(circle1.distance(circle2) - 8.485281374) < THRESHOLD) {
			System.out.println("PASSED: distance method");
		}
		else {
			System.out.println("FAILED: distance method");
		}
		if (Math.abs(circle2.distance(circle1) - 8.485281374) < THRESHOLD) {
			System.out.println("PASSED: distance method");
		}
		else {
			System.out.println("FAILED: distance method");
