 ...
 *
 * Purpose: This program converts a temperature in fahrenheit to either kelvin, rankine, reaumur, or celsius. The program 
 * the user's input in fahrenheit, and prompts the user to select what unit they would like their input converted to.
 * After the user makes their selection, the program outputs the converted temperature.
 *
