 ...
 *
 * Purpose: The purpose of this project is to debug and test the 
 * program which will the user to enter a temperature in Fahrenheit 
 * and display the equivalent temperature in a temperature scale of 
 * the user’s choice: Kelvin, Rankine, Reaumur, or Celsius.
 *
