 ...
 * Submission Date:  [Thursday February 25 2021]
 *
 * Purpose: A brief paragraph description of the
 * program. What does it do? In this program, the system
 * records a certain input using a Scanner and computes temperature
 * degrees based on the options given. Originally, the program had errors
 * but, with the debug system, the program has no errors in which
 * would affect the final out of the temperature.
 *
