 ...
 * Author:  [Anchal Patel] 
 * Submission Date:  [Feburary 22, 2021]
 *
 * Purpose: The purpose of my program is to allow the user to enter a temp
 * in Farenheit and display the equivalent temperature
 * in a temperature scale of the user's choice.
 *
