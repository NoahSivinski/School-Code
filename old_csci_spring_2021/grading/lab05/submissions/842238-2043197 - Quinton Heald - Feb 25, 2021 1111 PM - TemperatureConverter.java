 ...
 * Submission Date:  2-25-21
 *
 * Purpose: This is a debugged version of the TemperatureConverter code.
 * It allows the user to input an initial value of fahrenheit, 
 * choose the temperature scale they want to convert the fahrenheit value to,
 * and then the user is given the converted value within the output.
 *
