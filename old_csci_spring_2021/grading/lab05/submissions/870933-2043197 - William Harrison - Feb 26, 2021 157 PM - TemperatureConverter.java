 ...
 * 
 * Purpose: This program prompts the user to enter a degree
 * in fahrenheit that they would like to be converted to 
 * Kelvin, Rankine, Reaumur, or Celsius. The program also
 * stops the user if the fahrenheit temperature is too low
 * or if the user inputs a scale that is not defined.
 * 
...
public class TemperatureConverter{
 ...
 public static void main(String[] args) {
	 ...
	 if (tempScale < 1 || tempScale > 5) {  // Second-if statement: Set a breakpoint here
