...
/*
 * TemperatureConcerter.java
 * Author:  Reid Cogswell
 * Submission Date:  2-25-2021
 *
 * Purpose: The point of this lab is to debug the program below using the debugging tool in Eclipse. 
 * The code itself converts the temperature input by the user into there choice by selecting a 
 * number 1-4. 
 *
