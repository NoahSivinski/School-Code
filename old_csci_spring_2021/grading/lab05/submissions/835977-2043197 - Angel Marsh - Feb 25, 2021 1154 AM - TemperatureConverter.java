 ...
 *
 * Purpose: The purpose of this program is to covert  a
 * Fahrenheit temperature inputted by the user the specified
 * temperature scale and display the coverted value (in
