 ...
 *
 * Purpose: The purpose of this lab is to monitor
 * the values of the variables in a Java program and 
 * how to use the Eclipse debugger to locate 
 * its logical errors. This program should now allow
 * the user to enter a temperature in Fahrenheit
 * and display the temperature in a temperature
 * scale of the user's choice: Kelvin, Rankine, 
 * Reaumur, or Celsius.
 *
	...
	public static void main(String[] args) {
		...
		if (tempScale < 1 || tempScale > 4) {  
			...
			if (tempScale == 1) { 
				...
				convertedDegrees = (fahrenheit - 32.0) * (5.0/9.0); 
