 ...
 *
 * Purpose: This lab teaches how to monitor the value 
 * of the variables in a Java program and how to use the 
 * Eclipse debugger to locate its logical errors.
 * After the program is debugged, the program should allow the 
 * user to enter a temperature in Fahrenheit and display the equivalent 
 * temperature in a temperature scale of the user’s choice: 
 * Kelvin, Rankine, Reaumur, or Celsius. 
 *
