 ...
 * Purpose:
 * 
 * The purpose of this program is to prompt the user to enter a 
 * temperature in Fahrenheit and a temperature scale the user wants
 * to convert it to. If both the temperature in Fahrenheit and the 
 * temperature scale are valid, the program converts the temperature
 * in Fahrenheit to the specified temperature scale and displays the
 * converted value. A previous program was provided but had several 
 * bugs so the purpose of this program was also to test and debug
 * the previous program to make it a correct, error free program.
 *
