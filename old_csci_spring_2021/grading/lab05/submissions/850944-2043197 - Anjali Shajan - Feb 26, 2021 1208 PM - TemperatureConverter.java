 ...
 *
 * Purpose: The program allows a user to enter a temperature in Fahrenheit and allow them to covert that number into any temperature scale provided which is Kelvin, Rankine,
 * Reaumur and Celsius. The purpose of the lab was to fix the errors to allow the program to run smoothly.
 *
