 ...
 *the specified temperature scale and displays the converted value (all this is mentioned below as well). 
 *So the job initially is to debug to in order to get it to run the way it was designed as stated earlier.
 *
...
public class TemperatureConverter {
	...
	public static void main(String[] args) {
		...
		// Verify the user's input and creates Boundary on input
		...
		// User Unit Selection and Converter
		if (tempScale < 1 || tempScale > 4) {
			...
			if (tempScale == 1) {
				...
				convertedDegrees = fahrenheit + Math.abs(MIN_FAHRENHEIT);
