...
public class TemperatureConverter{
 ...
 public static void main(String[] args) {
	 ...
	 //checks to see which number the user inputed and then calculates the correct
	 //temperature conversion and stores in convertedDegrees
	 else {
		 if (tempScale == 1) { // Set a breakpoint here
			 convertedDegrees = ((fahrenheit - 32) * (5.0/9.0)) + 273.15;
			 tempScaleStr="Kelvin"; 
		 } else if (tempScale == 2) { 
