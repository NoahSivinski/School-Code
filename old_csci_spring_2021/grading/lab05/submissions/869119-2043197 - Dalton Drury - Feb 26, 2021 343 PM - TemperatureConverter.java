 ...
 *
 * Purpose: As stated in the instructions this program prompts the user to enter a temperature in Fahrenheit 
 * and a temperature scale the user wants to covert it to. The difference between the "original" error filled code
 * and mine is that mine gives us a proper output thanks to the Eclipse Debugger. 
 *
