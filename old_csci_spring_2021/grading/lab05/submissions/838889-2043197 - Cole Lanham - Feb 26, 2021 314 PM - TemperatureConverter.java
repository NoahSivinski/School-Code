 ...
 *
 *This lab's purpose was to teach how about the debugging process of a program.
 *The initial provided programs included multiple logic errors, which caused
 *us to utilized Eclipse's tools to find and fix issues. By learning about the 
 *debugging process we can grasp realistically how programmers tackle fixing code.
 *
 *
