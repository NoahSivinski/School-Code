 ...
 * Submission Date:  26th February 2021
 *
 * Purpose: The exercise being explored by Lab #4 is exploring debugging and using the debugging tool in Eclipse IDE.
 *
 ...
 public static void main(String[] args) {
	 ...
	 if (tempScale < 1 || tempScale > 4) {  // Second-if statement: Set a breakpoint here
		 ...
		 if (tempScale == 1) { // Set a breakpoint here
			 convertedDegrees = (fahrenheit + Math.abs(MIN_FAHRENHEIT))*5/9;
			 tempScaleStr="Kelvin"; 
		 } else if (tempScale == 2) { 
