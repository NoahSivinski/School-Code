 ...
 *
 *The program is designed to convert Fahrenheit to either Celsius, Reamur, Kelvin
 *or Rankine, depending on the user's choice. It uses if else statements to 
 *create the results and give the correct output. 
 *
