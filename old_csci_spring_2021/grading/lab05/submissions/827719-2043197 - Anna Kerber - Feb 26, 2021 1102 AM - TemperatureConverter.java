 ...
 *
 * Purpose: The purpose of this program is to convert an inputted
 * fahrenheit temperature to one of four other types of temperature
 * scales if the inputted value for fahrenheit and the type of 	
 * scale to convert to are valid.
 *
