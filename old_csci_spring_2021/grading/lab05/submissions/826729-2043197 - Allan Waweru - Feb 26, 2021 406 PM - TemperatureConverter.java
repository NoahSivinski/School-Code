 ...
 *
 * Purpose: This program prompts the user for a temperature in Fahrenheit then proceeds
 * to display the equivalent temperature in a scale of the user's choice
 *
