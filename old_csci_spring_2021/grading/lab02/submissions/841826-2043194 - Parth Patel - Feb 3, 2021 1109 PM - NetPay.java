 ...
 * 
 * Purpose: To create a program where the user can input the number of hours worked and
 * it will output their gross pay based on their deductions considering they are paid 
 * minimum wage.
 * 
